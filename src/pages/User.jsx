...
import Sppiner from "../components/layout/Sppiner"
...
function User() {
    ...
    const {name, type, avatar_url, location, bio,
           blog, twitter_username, login, html_url,
    ...
    return (
        <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3
                            lg:grid-3 md:grid-3 mb-8 md:gap-8">
                <div className="custom-card-image mb-6 md:mb-0">
                    <div className="rounded-lg shadow card image-full">
                        <figure>
                ...
                <div className="col span-2">
                    ...
                    <div className="w-full rounded-lg shadow-md bc-base-100 stats">
                        {location && (
                            <div className="stat"> 
            ...
            <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                <div className="stat">
                    <div className="stat-figure text-secondery">
                ...
                <div className="stat">
                    ...
                    <div className="stat-title pr-5"> Public Repoes </div>
